...
class _NoteTutUb extends _NoteTut$Ub {
  ...
  _GameCalculator get calculator => gameNote.game.ctrl.calculator;

  late SilenceNode note;
  trigger(SilenceNode node, Function(_NoteTutUb) callback) {
    note = node;
    milliseconds = node.duration.orElse(0);
