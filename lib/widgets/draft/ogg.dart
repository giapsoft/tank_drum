...
class _MyAppState extends State<MyApp> {
  ...
  List<String> files = ["F#3.ogg", "D5.ogg"];
  ...
  Future<void> loadPianoSounds() async {
    ...
    for (int i = 0; i < files.length; i++) {
      String name = "assets/note_sounds/tankdrum/" + files[i];
  ...
  Future<void> initPlatformState() async {
    ...
    // try {
    //   platformVersion =
    //       (await FlutterOggPiano.platformVersion) ?? _platformVersion;
                  ...
                  Column(
                    ...
                    children: [
                      ElevatedButton(
                          ...
                          child: Text(
                              "Play Sound 1 $_count time${_count == 1 ? "" : "s"}")),
                      ElevatedButton(
                          onPressed: () {
                            if (initialized) {
                              Map<int, List<Float64List>> maps = Map();
                          ...
                          child: Text(
                              "Play Sound 2 $_count time${_count == 1 ? "" : "s"}")),
                      ElevatedButton(
                          onPressed: () {
                            if (initialized) {
                              Map<int, List<Float64List>> maps = Map();
                          ...
                          child: Text(
                              "Play Both $_count time${_count == 1 ? "" : "s"}"))
                    ],
                  )
                ],
              ),
